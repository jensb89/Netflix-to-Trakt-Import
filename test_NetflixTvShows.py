...
def test_addSingleTvShow():
    ...
    ret = netflixHistory.addEntry("Peaky Blinders – Gangs of Birmingham: Staffel 1: Geschenk des Teufels","03.10.21")
    ...
    assert( netflixHistory.shows[0].seasons[0].name == None )
...
def test_addMultipleTvShows():
    ...
    netflixHistory = NetflixTvHistory()
    ret1= netflixHistory.addEntry("Peaky Blinders – Gangs of Birmingham: Staffel 1: Geschenk des Teufels","03.10.21")
    ret2 = netflixHistory.addEntry("Haus des Geldes: Teil 5: Wunschdenken","03.12.21")
    ret3 = netflixHistory.addEntry("Haus des Geldes: Teil 5: Sicherheitsventil","03.12.21")
    assert( ret1 == ret2 == ret3 == True )
    assert( netflixHistory.hasTvShow("Peaky Blinders – Gangs of Birmingham") )
    assert( netflixHistory.hasTvShow("Haus des Geldes") )
    assert( len(netflixHistory.getTvShow("Haus des Geldes").getSeasonByNumber("5").episodes) == 2 )
